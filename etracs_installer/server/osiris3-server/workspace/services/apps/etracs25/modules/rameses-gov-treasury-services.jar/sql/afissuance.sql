...
from (
	select 
		afc.controlid as objid, afi.afid, afi.respcenter_objid as respcenterid, afi.respcenter_name as respcentername, afi.startseries, afi.endseries,
	...
	select 
		afc.controlid as objid, afi.afid, afi.respcenter_objid as respcenterid, afi.respcenter_name as respcentername,  null as startseries, null as endseries,
