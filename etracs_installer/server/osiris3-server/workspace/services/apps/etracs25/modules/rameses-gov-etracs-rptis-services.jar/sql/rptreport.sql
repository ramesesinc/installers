...
SELECT  
	b.objid AS barangayid, 
	b.name AS barangay, 
	SUM( IFNULL(CASE WHEN r.taxable = 1 THEN 1 ELSE 0.0 END,0) ) AS currenttaxablecount, 
...
SELECT  
	b.objid AS barangayid, 
	b.name AS barangay, 
	SUM( IFNULL(CASE WHEN r.taxable = 1 THEN 1 ELSE 0.0 END,0) ) AS cancelledtaxablecount, 
...
SELECT  
	b.objid AS barangayid, 
	b.name AS barangay, 
	SUM( IFNULL(CASE WHEN r.taxable = 1 THEN 1 ELSE 0.0 END,0) ) AS endingtaxablecount, 
